...
export const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-[100dvh] bg-slate-950 relative flex flex-col overflow-hidden">
      {/* Background Effects (Absolute, no interaction) */}
      ...
      <div className="flex-1 w-full overflow-y-auto flex items-center justify-center p-4 z-10">
          <div className="w-full max-w-4xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center my-8">
                     ...
                     <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
                        {avatars.map(char => (
                          <button
                            ...
                            className={`w-12 h-12 rounded-full flex items-center justify-center text-2xl transition-all border-2 flex-shrink-0 ${
